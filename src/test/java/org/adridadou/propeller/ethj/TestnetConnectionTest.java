...
public class TestnetConnectionTest {
    ...
    private MyContract2 publishAndMapContract(EthereumFacade ethereum) throws Exception {
        SolidityContractDetails compiledContract = ethereum.compile(SoliditySourceFile.from(new File("src/test/resources/contract.sol"))).findContract("myContract2").get();
